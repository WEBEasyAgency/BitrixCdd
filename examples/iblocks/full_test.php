 ...
 */
return [
    'version'   => '1.0',       // Необязательно, '1.0' по умолчанию
    'sync_mode' => 'soft',       // Необязательно, off | soft | ensure | once | danger (по умолчанию 'soft')
    'priority'  => 100,          // Необязательно, порядок регистрации (по умолчанию 500, меньше = раньше)
